...
namespace FribergRealEstatesAPI.Migrations
{
    ...
    [Migration("20250507203419_added chathub-models")]
    partial class addedchathubmodels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FribergRealEstatesAPI.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergRealEstatesAPI.Models.ChatHubModels.Dialogue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergRealEstatesAPI.Models.ChatHubModels.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergRealEstatesAPI.Models.Admin", b =>
                {
                    b.HasOne("FribergRealEstatesAPI.Data.ApiUser", "ApiUser")
                        .WithOne("Admin")
                        .HasForeignKey("FribergRealEstatesAPI.Models.Admin", "ApiUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FribergRealEstatesAPI.Models.ChatHubModels.Message", b =>
                {
                    b.HasOne("FribergRealEstatesAPI.Models.ChatHubModels.Dialogue", null)
                        .WithMany("Messages")
